...
export default async function Cs2TrendsPage({ searchParams }: PageProps) {
  ...
  if (!isSupabaseConfigured()) {
    return (
      <div className="space-y-8">
        <PageHeader
          eyebrow="Counter-Strike 2 analysis · Map-to-map trends"
      ...
      {rawMaps.length === 0 ? (
        <div className="border-border bg-surface rounded-lg border p-8 text-center">
          ...
          <div className="mt-4 flex justify-center">
            <a
              href="/projects/cs2/trends?player=donk"
