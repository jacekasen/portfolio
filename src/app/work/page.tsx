...
function FeaturedProject({ project, headingId }: { project: Project; headingId: string }) {
  return (
    <article className="on-ink bg-ink text-on-ink grid gap-9 p-7 md:grid-cols-[minmax(0,1.35fr)_minmax(16rem,0.65fr)] md:p-10">
      <div>
        ...
        <h2 id={headingId} className="mb-5 text-3xl leading-tight font-bold md:text-4xl">
          {project.title}
        </h2>
